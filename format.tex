...
\section{はじめに}
 ...
 て一般的な，タ イトル1段組，本文は左右2段組に対応している．
...
また，本稿では日本語を主体とする文書におけるマージンの設定を
 \texttt{geometry}パッケージを利用して行う方法についても述べる．特に，
 反面の高さの自動補正について解説する \footnote{補正により，脚注を用いても\underline{行の下側が左右の段で揃う．}}．
...
\cmd{keywords}コマンドを追加した．\cmd{maketitle}を用いることでこれら
を含むタイトルを出力できる．なお，\texttt{jsarticle}が標準で備える
