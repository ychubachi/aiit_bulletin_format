...
%% 英文表題
%%
\etitle{Style and Layout of an AIIT Bulletin\\-- 2013 --}
...
%% 4.タイトルを出力
%%
%% \maketiteleにある[5pt]というオプションはタイトルと本文の間隔
%% を調整するものです．1ページ目の最下端の行が左右の段で揃わない
...
\begin{figure}
 ...
 % 図を7行取り（7\baselineskip）して挿入する例
 \includegraphics[height=7\baselineskip]{aiit_symbol.eps}
 \caption{図のキャプション}
 \label{fig:one}
\end{figure}
