...
\section{はじめに}
 ...
 \texttt{aiitjsarticle} について述べる．日本語のレイアウトに欠かせない
 「行取り」のマクロを追加し，二段組の左右の行が揃うことをより徹底した．
 また，英文の表題，著者名，概要，キーワードを出力できるようにした．標準
 的なクラスファイルに最低限の拡張を施し，より美しく，実用的なレイアウト
 を実現することを狙う．
\section{スタイルの定義}
\subsection{基本版面}
A4用紙縦．
